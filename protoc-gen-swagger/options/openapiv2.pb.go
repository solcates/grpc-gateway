...
type Operation struct {
	...
	// customheaders allows you to add headers to this operation
	Customheaders        map[string]*_struct.Value `protobuf:"bytes,14,rep,name=customheaders,proto3" json:"customheaders,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}                  `json:"-"`
	XXX_unrecognized     []byte                    `json:"-"`
	XXX_sizecache        int32                     `json:"-"`
}
...
func (m *Operation) GetCustomheaders() map[string]*_struct.Value {
	if m != nil {
...
type Tag struct {
	...
	// customheaders allows you to add custom headers to this operation, in key=type i.e. hello=string
	// this is helpful for passing in canary parameters to the openapi generators
	Customheaders        map[string]string `protobuf:"bytes,4,rep,name=customheaders,proto3" json:"customheaders,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *Tag) GetCustomheaders() map[string]string {
	if m != nil {
		return m.Customheaders
	}
	return nil
...
func init() {
	...
	proto.RegisterMapType((map[string]*_struct.Value)(nil), "grpc.gateway.protoc_gen_swagger.options.Operation.CustomheadersEntry")
	...
	proto.RegisterMapType((map[string]string)(nil), "grpc.gateway.protoc_gen_swagger.options.Tag.CustomheadersEntry")
...
var fileDescriptor_ba35ad8af024fb48 = []byte{
	...
	,
}
